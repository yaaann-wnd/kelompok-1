                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight-bolder text-info text-gradient">Login Siswa</h3>
                                    <p class="mb-0">Masukkan NIS</p>
                                </div>
                                <div class="card-body">
                                    <form role="form" method="POST">
                                        <label>NIP</label>
                                        <div class="mb-3">
                                            <input type="number" min="1" class="form-control" name="nis" placeholder="NIP" aria-label="Email">
                                        </div>                                        
